...
}).constant('appName', 'appoints-client').constant('appVersion', '0.1.0').constant('appDescription', 'Doctor appointment scheduler app');
;
...
angular.module('appoints.dashboard', [
  ...
  '$location',
  'flash',
  function DashboardController($scope, config, usersession, $http, $location, flash) {
...
angular.module('appoints.logindetails', [
  ...
  'config',
  'usersession',
  function LoginDetailsController($scope, flash, $http, $window, $rootScope, $location, config, usersession) {
...
angular.module('appoints.profile', [
  ...
  'flash',
  '$routeParams',
  function ProfileController($scope, $rootScope, $timeout, config, usersession, $http, $location, flash, $routeParams) {
    // var profileVM = this;
