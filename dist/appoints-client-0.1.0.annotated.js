...
angular.module('appoints.config', []).constant('config', { 'apiEndpoint': 'http://44.208.29.151/DocConnectAPI' }).constant('appName', 'appoints-client').constant('appVersion', '0.1.0').constant('appDescription', 'Doctor appointment scheduler app');
;
