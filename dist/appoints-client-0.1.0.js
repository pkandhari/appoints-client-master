...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('appointments/landingpage.html',
...
.constant("appDescription", "An example appointment scheduler app")
...
angular.module('appoints.signup', [
    ...
    .controller('UserSignupCtrl', function UserSignupController($scope, $window, _, appointsapi, flash, moment) {
