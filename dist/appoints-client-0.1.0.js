...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('auth/logindetails.html',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('auth/usersignin.html',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('auth/usersignup.html',
...
.constant("config", {
	"apiEndpoint": "http://44.208.29.151/DocConnectAPI"
})
